        ...
        <div class="row mt-20">
            <div class="col-md-12">
                <div class="card card-custom card-stretch">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">{{translate('Captins custody')}}</h3>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="col-md-12">
            <div class="card card-custom card-stretch">
                ...
                <div class="card-body">
                    ...
                    @php
                        $missions = App\Mission::where('captain_id',Auth::user()->userCaptain->captain_id)->where('due_date',Carbon\Carbon::today()->format('Y-m-d'))->get();
                    @endphp
