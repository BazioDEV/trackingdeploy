                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; padding-top: 10px;" colspan="1">
                                                                        @if ($shipment->amount_to_be_collected && $shipment->amount_to_be_collected  > 0)
                                                                            <span style="font-size:16px; font-weight:bold; padding:10px;">{{translate('COD')}}: {{format_price(convert_price($shipment->amount_to_be_collected))}}</span>
                                                                            <br />
                                                                        @endif
